...
1. How would you describe acessibility on the web to someone new to programming?
   Accessibility is super important for insuring that everyone is able to access the content. We have to design and implement as much features as we can. Always think about the acessibility for every single person on the planet.
2. Talk about 3 different things you can do to ensure your website is accessible.
   1.We need the viewport meta tag in the head of your doc 2. We need to use media queries, so that the content looks good in every screen size. 3. we need to use responsize scaling measurments like percentages instead on no responsize like px.
3. How would you explain the concept of a variable to someone new to programming?
   A variable is a item which we store data.
4. What is the purpose of using functions in code?
   Fuctions are the way we do things. If you want an abilty to do anything and not be repetative in our code make a function to do that ability and reuse to for more effiecent coding.
